package com.cgsf.justgifit.controller;
...
public class UploadController {
    ...
    public String upload(@RequestPart("file") MultipartFile file,
        ...
        Path output = Paths.get("C:\\Users\\chirag.soni\\Desktop\\gif\\" + System.currentTimeMillis() + ".gif");
        ...
        System.out.println("output::"+output.getFileName().toString());
